  ...
  return (
    <section className="bg-background py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <motion.h2
          {...reveal}
          className="max-w-2xl text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground"
        >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-16 pb-20 md:pt-24 md:pb-28 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-xl">
            SMS, email, automations, AI, reporting and integrations in one place — so every
            conversation reacts to what your customers actually do.
          </p>
          <div className="mt-9 flex flex-wrap gap-3">
            <Link
              to="/auth"
              className="inline-flex items-center gap-1.5 bg-primary text-primary-foreground rounded-full px-5 py-3 font-semibold hover:bg-primary/90 transition-colors"
            >
              Sign up <ArrowRight className="size-4" />
            </Link>
            <Link
              to="/contact"
              className="inline-flex items-center gap-1.5 border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-full px-5 py-3 font-semibold transition-colors"
            >
              Take a tour
            </Link>
          </div>
          <div className="mt-8 flex items-center gap-6 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1.5">
              <Check className="size-3.5" /> 50 free credits
            </span>
            <span className="flex items-center gap-1.5">
              <Check className="size-3.5" /> GDPR-ready
            </span>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="bg-muted rounded-3xl p-10 md:p-14 min-h-[460px] relative overflow-hidden">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "radial-gradient(circle at 20% 30%, rgba(255,255,255,0.6) 0, transparent 40%), radial-gradient(circle at 80% 70%, rgba(0,0,0,0.06) 0, transparent 45%)",
              }}
            />
            <motion.div
...
const features = [
  {
    icon: MessageSquare,
    title: "Power personalization with better data",
    text: "Deliver exactly what each customer needs with built-in data, segments and two-way conversations.",
  },
  {
    icon: Globe2,
    title: "Meet users where they are, worldwide",
    text: "Engage customers around the world with SMS reaching 190+ countries on tier-1 carriers.",
  },
  {
    icon: Sparkles,
    title: "Grow faster with automation & optimization",
    text: "Automated A/B testing and list-growth tools drive more SMS revenue, even faster.",
  },
  {
    icon: BarChart3,
    title: "Take action with clear, omnichannel insights",
    text: "Know your next move with multi-channel attribution and revenue reporting.",
  },
];
  ...
  return (
    <section className="bg-background pt-8 pb-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <motion.h2
          {...fade}
          className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground max-w-2xl"
        >
  ...
  return (
    <section className="bg-background py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div
          {...fade}
          className="bg-muted rounded-3xl p-10 md:p-14 min-h-[420px] flex items-center justify-center"
        >
        ...
        <motion.div {...fade}>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">
            The data to deliver text messages your customers want
          </h2>
          <p className="mt-5 text-muted-foreground">
            Stronger customer relationships start with the best data, so you send the timely,
            relevant texts they actually want to receive.
          </p>
          <ul className="mt-6 space-y-4 text-muted-foreground">
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Quickly
              segment, personalize, and act on insights with our unified data platform.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Automated
              SMS conversations to address FAQs and tailor experiences.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Collect
              transactional consent separately from marketing for full subscriber control.
            </li>
          </ul>
        </motion.div>
      </div>
  ...
  return (
    <section className="bg-background py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div {...fade}>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">
            Reach customers across channels, and across the globe
          </h2>
          <p className="mt-5 text-muted-foreground">
            With all your channels in one platform, it's easy to combine SMS, email, and mobile
            messaging into global omnichannel experiences.
          </p>
          <ul className="mt-6 space-y-4 text-muted-foreground">
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Meet
              customers anywhere with multi-channel flows.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Engage
              globally — SMS available in 190+ countries.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Send
              confidently with built-in compliance and trust.
            </li>
          </ul>
        </motion.div>
        <motion.div
        ...
        >
          <div className="space-y-3 w-full max-w-sm">
            <div className="bg-card rounded-xl border shadow-sm bg-primary/10 text-primary px-4 py-3 text-sm font-semibold">
              FLOW TRIGGER
            </div>
            <div className="bg-card rounded-xl border shadow-sm px-4 py-3 text-sm">
              Price dropped and item viewed
            </div>
            <div className="bg-card rounded-xl border shadow-sm px-4 py-3 text-sm">
              Consented to receive SMS?
            </div>
            <div className="flex gap-2">
              <div className="bg-card rounded-xl border shadow-sm bg-primary/10 text-primary px-4 py-2 text-sm font-semibold">
                Yes
              </div>
              <div className="bg-card rounded-xl border shadow-sm px-4 py-2 text-sm">No</div>
            </div>
            <div className="bg-card rounded-xl border shadow-sm px-4 py-3 text-sm">
              View discounted item
            </div>
          </div>
        </motion.div>
      </div>
  ...
  return (
    <section className="bg-background py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={r.l} className="flex items-center justify-between gap-3">
                  ...
                  <div
                    className={`px-3 py-1.5 text-xs rounded-md border ${r.active ? "bg-primary/10 text-primary border-transparent font-medium" : "border-border"}`}
                  >
                    {r.v}
                  </div>
                </div>
        ...
        <motion.div {...fade}>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">
            Tap into actionable SMS insights
          </h2>
          <p className="mt-5 text-muted-foreground">
            Make smarter decisions for your SMS strategy with built-in multi-channel reporting.
          </p>
          <ul className="mt-6 space-y-4 text-muted-foreground">
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Accurately
              attribute sales with last-touch multi-channel attribution.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Manage
              budgets with usage reporting across every channel.
            </li>
            <li className="flex gap-3">
              <span className="size-1.5 rounded-full bg-neutral-900 mt-2.5 shrink-0" /> Analyze
              subscriber growth and engagement trends over time.
            </li>
          </ul>
        </motion.div>
      </div>
    ...
    <section className="bg-background py-20 border-t border-border">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <motion.div {...fade} className="max-w-3xl">
          ...
          <p className="mt-5 text-muted-foreground">
            Each country regulates SMS a little differently. You never leave Xellvio — we handle
            whichever path applies to where you're sending, and each account does its own
            verification right inside the app.
          </p>
        </motion.div>
          ...
          {rows.map((r, i) => (
            ...
            >
              <Card className="p-6 h-full flex flex-col">
                <div
                  className={`inline-flex self-start items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold ${toneMap[r.tone]}`}
                >
        ...
        <motion.p {...fade} className="mt-10 text-sm text-muted-foreground max-w-3xl">
          <strong className="text-foreground">Bottom line:</strong> for most of the world, you just
          pick a Sender ID and send. For the US and Canada, we walk you through the toll-free
          verification wizard. For countries that need local carrier whitelisting, we file the
          request for you — no external portal, no paperwork.
        </motion.p>
      </div>
    </section>
  );
  ...
  return (
    <section className="bg-background py-20 border-t border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <motion.h2
          {...fade}
          className="text-3xl sm:text-4xl font-extrabold text-foreground max-w-2xl"
        >
          From signup to first send in under 5 minutes
        </motion.h2>
          ...
          {faqs.map((f, i) => (
            <div key={i} className="border-b border-border">
              ...
              >
                {f.q}
                <ChevronDown
                  className={`mt-1 size-5 shrink-0 transition-transform ${open === i ? "rotate-180" : ""}`}
                />
              </button>
              {open === i && (
                <p className="pb-7 max-w-2xl text-muted-foreground leading-relaxed">{f.a}</p>
              )}
            </div>
          ))}
        </div>
    ...
    <section className="bg-background py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-3xl bg-neutral-950 text-white p-12 md:p-16 relative overflow-hidden">
          <div
            className="absolute -right-20 -top-20 size-80 rounded-full"
            style={{
              background: "radial-gradient(circle, rgba(207,230,251,0.25), transparent 70%)",
            }}
          />
          <div className="relative max-w-2xl">
            ...
            <p className="mt-4 text-white/70 text-lg">
              Start free with 50 credits. No card required.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/auth">
                <Button
                  size="lg"
                  className="rounded-full bg-card text-foreground hover:bg-card/90 font-semibold px-6"
                >
                  Sign up <ArrowRight className="size-4 ml-1" />
                </Button>
              </Link>
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full bg-transparent border-white/40 text-white hover:bg-card/10 font-semibold px-6"
                >
                  <Play className="size-4 mr-1.5" /> Take a tour
                </Button>
              </Link>
            </div>
          </div>
