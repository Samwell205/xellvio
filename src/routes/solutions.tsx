...
const solutions = [
  {
    icon: ShoppingBag,
    title: "Commerce campaigns",
    text: "Launch promos, drops, back-in-stock alerts, and winback SMS with contact segments and scheduled sends.",
  },
  {
    icon: BellRing,
    title: "Transactional alerts",
    text: "Send one-time passwords, delivery updates, appointment reminders, and account notifications from verified identities.",
  },
  {
    icon: Workflow,
    title: "Lifecycle automation",
    text: "Build message flows around signup, purchase, inactivity, birthdays, and consent status.",
  },
  {
    icon: Code2,
    title: "Developer messaging",
    text: "Use API keys, webhooks, and delivery logs to connect SMS to your product and internal systems.",
  },
];

const lifecycle = [
  "Collect consent",
  "Import or segment contacts",
  "Approve sender",
  "Compose SMS",
  "Schedule or trigger",
  "Track delivery",
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20 md:py-28 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] items-center">
            <div>
              ...
              <p className="mt-5 text-lg text-muted-foreground max-w-2xl">
                Run SMS like mature platforms do: consent-first audiences, verified sender
                identities, clear campaign flows, and measurable delivery.
              </p>
            ...
            <div className="rounded-xl border bg-card p-5 card-elevated">
              ...
              <div className="mt-5 space-y-3">
                {lifecycle.map((step, index) => (
                  ...
                  >
                    <div className="size-7 rounded-md bg-primary/10 text-primary grid place-items-center text-xs font-bold">
                      {index + 1}
                    </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 grid gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                Users cannot send until the sender identity is verified or approved, and contacts
                can be organized around consent and opt-out status.
              </p>
            </div>
            <Card className="p-6 lg:col-span-2">
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <CheckItem
                  ...
                  text="Import contacts, manage lists, and segment before sending."
                />
                <CheckItem
                  icon={MessageSquare}
                  title="Verified senders"
                  text="Personal numbers must pass OTP; sender IDs need admin approval."
                />
                <CheckItem
                  icon={ShieldCheck}
                  title="Delivery controls"
                  text="Campaigns use approved identities and store delivery status."
                />
              </div>
            </Card>
          </div>
