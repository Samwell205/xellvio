...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Support — Samwell Global SMS" },
      { name: "description", content: "Reach the Samwell Global SMS team for sales, technical support, billing, or sender ID approvals." },
      { property: "og:title", content: "Contact Support — Samwell Global SMS" },
