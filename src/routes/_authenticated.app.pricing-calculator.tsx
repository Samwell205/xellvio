...
function PricingCalculatorPage() {
  const ratesQ = useQuery({
    ...
    queryFn: async () => (await supabase.from("country_rates_public").select("country_code,country_name,dial_prefix,sell_price,mms_multiplier,active,sender_supports_inbound").order("country_name")).data ?? [],
  });
