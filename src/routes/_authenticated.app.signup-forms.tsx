  ...
  head: () => ({
    meta: [
      { title: "Sign-up forms — Xellvio" },
      {
        name: "description",
        content:
          "Design hosted sign-up forms with templates and an AI design assistant, then embed them anywhere.",
      },
  ...
  if (builder.doc) {
    return (
      <VisualBuilder
        ...
        embedCode={
          builder.doc.slug
            ? embedFor({ slug: builder.doc.slug, name: builder.doc.name })
            : undefined
        }
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4 sm:flex sm:flex-wrap sm:justify-between">
        <div className="min-w-0 space-y-1">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Build a form visually, start from a template, or describe it and let the design
        ...
        <Card className="flex flex-col items-center gap-4 p-14 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="mx-auto max-w-md text-sm text-muted-foreground">
              Drag in the pieces you want, edit every word and colour, then share the link or embed
              it on your site.
            </p>
          </div>
            ...
            return (
              <Card key={f.id} className="space-y-3 p-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Badge variant={f.published ? "default" : "outline"}>
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      navigator.clipboard.writeText(urlFor(f.slug));
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      navigator.clipboard.writeText(embedFor(f));
                  ...
                  <Button variant="outline" size="sm" onClick={() => dup.mutate(f.id)}>
                  ...
                  <Button
                    ...
                    onClick={async () =>
                      downloadCsv(
                        (await exportFn({ data: { sourceId: f.id } })) as any[],
                        `${f.slug}-signups.csv`,
                      )
                    }
                  >
        ...
        <Card className="p-5">
          <div className="mb-3 flex items-center justify-between gap-3">
            ...
            <Button
              ...
              size="sm"
              onClick={async () =>
                downloadCsv((await exportFn({ data: {} })) as any[], "all-signups.csv")
              }
            >
              <Download className="mr-1 size-3" />
              Export all
