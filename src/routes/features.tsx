...
const items = [
  {
    ...
    text: "Send to millions in minutes with smart batching, throttling, and retries.",
  },
  {
    icon: Calendar,
    title: "Scheduled Messaging",
    text: "Plan campaigns days or weeks ahead, in the recipient's local timezone.",
  },
  {
    icon: Tag,
    title: "Sender ID",
    text: "Use approved sender IDs per country with automatic fallback rules.",
  },
  {
    icon: BarChart3,
    title: "Analytics",
    text: "Real-time delivery, country breakdown, and exportable reports.",
  },
  {
    icon: Users,
    title: "Contact Management",
    text: "Tags, segments, import/export, dedupe and opt-out workflows.",
  },
  {
    icon: Code2,
    title: "Developer API",
    text: "REST API, SDKs, and webhook events for delivery updates.",
  },
  {
    icon: Workflow,
    title: "Campaign Automation",
    text: "Trigger campaigns from CRM events, schedules or webhooks.",
  },
  {
    icon: Settings2,
    title: "Developer Tools",
    text: "Sandbox, logs, test numbers and template manager.",
  },
];
        ...
        <section className="hero-gradient">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20 md:py-28 text-center">
            ...
            <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
              Designed for marketing, product and engineering teams that need reliable messaging at
              any scale.
            </p>
          </div>
        </section>
