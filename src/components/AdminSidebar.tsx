...
import {
  ...
  Mail, MessageSquareText, Activity, LogOut, ShieldCheck, ClipboardList, ShieldOff, Radio, GraduationCap, Megaphone, Phone, Scale, PhoneOutgoing, Send,
  Blocks,
} from "lucide-react";
import {
...
const groups: { label: string; items: { title: string; url: string; icon: any; exact?: boolean }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Academy authoring", url: "/admin/academy", icon: GraduationCap },
    ],
  },
];
        ...
        <div className="p-2 flex items-center gap-2">
          ...
          {!collapsed && (
            <div className="leading-tight">
              <div className="font-semibold text-sm text-sidebar-foreground">Xellvio</div>
