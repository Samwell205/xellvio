...
const GREETING: Msg = {
  role: "assistant",
  content:
    "👋 Hi! I'm the Xellio assistant. Ask me about sign up, verifying your email, importing contacts, sending SMS, or anything else.",
};
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b bg-secondary px-4 py-3 text-secondary-foreground">
          <div>
            <div className="text-sm font-semibold">Xellio Support</div>
