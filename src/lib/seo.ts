...
export const PUBLIC_PAGES: PublicPage[] = [
  ...
  { path: "/automations", changefreq: "monthly", priority: "0.8", group: "product" },
  { path: "/landing-pages", changefreq: "monthly", priority: "0.8", group: "product" },
  { path: "/signup-forms", changefreq: "monthly", priority: "0.8", group: "product" },
  { path: "/audiences", changefreq: "monthly", priority: "0.8", group: "product" },
